...
const Task = () => {
  ...
  return (
    <>
      <MainLayout>
        <form className='m-auto my-20 max-w-[1000px] bg-green-200 p-8 border-2  shadow-md rounded-md'>
          {loading ? (
            <Loader />
          ) : (
            <>
              ...
              <div className="mb-4">
                <label htmlFor="description">Description Your Task!</label>
              ...
              <button className='ml-4 bg-red-400 text-white px-4 py-2 font-medium' onClick={() => navigate("/")}>Cancel</button>
              {mode === "update" && <button className='ml-4 bg-blue-500 text-white px-4 py-2 font-medium hover:bg-blue-500' onClick={handleReset}>Reset</button>}
            </>
          )}
        </form>
      </MainLayout>
